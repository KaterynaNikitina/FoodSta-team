...
function addHeroAnimation() {
    ...
    element.classList.add("animate__animated", "animate__backInLeft", "animate__slow");
    setTimeout(removeHeroAnimation, 2000);
}
function removeHeroAnimation() {
    let element = document.querySelector(".hero__title");
    element.classList.remove("animate__animated", "animate__backInLeft", "animate__slow");
}
...
function addCustomersAnimation() {
    ...
    part.classList.add("animate__animated", "animate__backInLeft", "animate__slow");
    let element = document.querySelectorAll("li.customers__item");
    for (let el of element)el.classList.add("animate__animated", "animate__rotateInDownLeft", "animate__slow");
    setTimeout(removeCustomersAnimation, 2000);
}
function removeCustomersAnimation() {
    let part = document.querySelector(".customers__title");
    part.classList.remove("animate__animated", "animate__backInLeft", "animate__slow");
    let element = document.querySelectorAll("li.customers__item");
    for (let el of element)el.classList.remove("animate__animated", "animate__rotateInDownLeft", "animate__slow");
}
...
//# sourceMappingURL=index.b7b23b5e.js.map
